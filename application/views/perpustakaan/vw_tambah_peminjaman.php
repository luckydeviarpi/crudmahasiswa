                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" name="nama_buku" id="nama_buku"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Genre
                                                    Buku</label>
                                                <input class="form-control" type="text" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" name="genre_buku" id="genre_buku"
                                                    required placeholder="Genre Buku">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" name="tanggal_peminjaman"
                                                    id="tanggal_peminjaman" required placeholder="Tanggal Peminjaman">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Tanggal
                                                    Pengembalian</label>
                                                <input class="form-control" type="date" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" name="tanggal_pengembalian"
                                                    id="tanggal_pengembalian"  placeholder="Tanggal Pengembalian (optional)">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Nomor Anggota</label>
                                                <input class="form-control" type="text" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" name="nomor_anggota" id="nomor_anggota" required
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" onfocus="focused(this)"
                                                    onfocusout="defocused(this)" name="nama_peminjam" id="nama_peminjam"
