                    ...
                    <div class="row">
                        ...
                        <div class="card card-plain">
                                    ...
                                    <form method="POST" action="<?= base_url('Auth/cek_login'); ?>">
                                        <div class="mb-3">
                                            <input type="email" class="form-control form-control-lg" placeholder="Email"
                                               name="email" value="<?= set_value('email')?>" id="email">
                                        </div>
                                        <div class="mb-3">
                                            <input type="password" value="<?= set_value('password')?>" id="password" class="form-control form-control-lg" placeholder="Password" name="password">
                                        </div>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-4 text-sm mx-auto">
                                        Belum punya akun?
                                        <a href="<?= base_url();?>Auth/register" class="text-primary text-gradient font-weight-bold">Sign
                                            up</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"I have no enemies."</h4>
                                <p class="text-white position-relative">-Thorfinn Karlsefni Thórdarson</p>
                            </div>
                        </div>
                    </div>
                </div>
